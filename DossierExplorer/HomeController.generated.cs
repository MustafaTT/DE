...
namespace DossierExplorer.Controllers
{
    public partial class HomeController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult Folder()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Folder);
        }
        ...
        static readonly ActionParamsClass_Folder s_params_Folder = new ActionParamsClass_Folder();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_Folder FolderParams { get { return s_params_Folder; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_Folder
        {
            public readonly string subFolder = "subFolder";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Browser = "~/Views/Home/Browser.cshtml";
            public readonly string Contact = "~/Views/Home/Contact.cshtml";
            public readonly string Files = "~/Views/Home/Files.cshtml";
            public readonly string Folder = "~/Views/Home/Folder.cshtml";
            public readonly string Index = "~/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : DossierExplorer.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void FolderOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string subFolder);

        [NonAction]
        public override System.Web.Mvc.ActionResult Folder(string subFolder)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Folder);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "subFolder", subFolder);
            FolderOverride(callInfo, subFolder);
            return callInfo;
        }
