...
namespace ElFinder.DTO
{
    ...
    internal abstract class DTOBase
    {
        ...
        public static DTOBase Create(DirectoryInfo directory, Root root)
        {
            ...
            {
                string parentFullname = directory.Parent.FullName;
                string rootdir = root.Directory.FullName;
                int lenghtparent = parentFullname.Length;

                int lengthroot = rootdir.Length;
