...
(function (a)
{
    window.elFinder = function (b, c)
    {
        ...
        {
            var c = !1, d = { cssClass: "elfinder-dialog-confirm", modal: !0, resizable: !1, Name: this.i18n(b.title || "confirmReq"), buttons: {}, close: function () { !c && b.cancel.callback(), a(this).elfinderdialog("destroy") } }, e = this.i18n("apllyAll"), f, g; return b.reject && (d.buttons[this.i18n(b.reject.label)] = function ()
            {
        ...
        var b = this, c = b.fm, d = [], e = function (b) { return a.map(b, function (b) { return b.read && a.inArray(b.mime, d) !== -1 ? b : null }) }; this.disableOnSearch = !0, c.bind("open reload", function () { d = c.option("archivers").extract || [], b.change() }), this.getstate = function (a) { var a = this.files(a), b = a.length; return !this._disabled && b && this.fm.cwd().write && e(a).length == b ? 0 : -1 }, this.exec = function (b)
        {
            var e = this.files(b), f = a.Deferred(), g = e.length, h, i, j, k = !1, l = !1, m = a.map(c.files(b), function (a) { return a.name }), n = {}; a.map(c.files(b), function (a) { n[a.name] = a }); var o = function (a) { switch (a) { case "overwrite_all": k = !0; break; case "omit_all": l = !0 } }, p = function (b) { !b.read || !c.file(b.phash).write ? (i = ["errExtract", b.name, "errPerm"], c.error(i), f.reject(i)) : a.inArray(b.mime, d) === -1 ? (i = ["errExtract", b.name, "errNoArchive"], c.error(i), f.reject(i)) : c.request({ data: { cmd: "extract", target: b.hash }, notify: { type: "extract", cnt: 1 }, syncOnFail: !0 }).fail(function (a) { f.isRejected() || f.reject(a) }).done(function () { }) }, q = function (b, d)
            {
                var e = b[d], i = e.name.replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/ig, ""), r = a.inArray(i, m) >= 0; r && n[i].mime != "directory" ? c.confirm({
                    Name: c.i18n("ntfextract"), Content: c.i18n(["errExists", i, "confirmRepl"]), accept: {
